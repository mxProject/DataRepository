...
namespace Test.DbRepositories
{
    ...
    /// </summary>
    internal class SampleEntityAsyncRepositoryWithContext : DbAsyncReadWriteRepositoryWithContextBase<SampleEntity, int, SampleContext>
    {
        /// <summary>
        ...
        public SampleEntityAsyncRepositoryWithContext(Func<IDbConnection> connectionActivator, bool useTransactionScope, Action<IDbCommand> configureCommand)
        ...
        /// <param name="keys">The keys.</param>
        /// <returns>The entities.</returns>
        protected async override IAsyncEnumerable<SampleEntity> GetRangeAsync(Func<IDbCommand> commandActivator, IEnumerable<int> keys, SampleContext context, [EnumeratorCancellation] CancellationToken cancellation = default)
        {
            await Task.Yield();
        ...
        /// <param name="keys">The keys.</param>
        /// <returns>The entities.</returns>
        protected async override IAsyncEnumerable<SampleEntity> GetRangeAsync(Func<IDbCommand> commandActivator, IAsyncEnumerable<int> keys, SampleContext context, [EnumeratorCancellation] CancellationToken cancellation = default)
        {
            await Task.Yield();
        ...
        /// <param name="commandActivator">The method to activate a new command.</param>
        /// <returns>The entities.</returns>
        protected async override IAsyncEnumerable<SampleEntity> GetAllAsync(Func<IDbCommand> commandActivator, SampleContext context, [EnumeratorCancellation] CancellationToken cancellation = default)
        {
            await Task.Yield();
        ...
        /// <param name="commandActivator">The method to activate a new command.</param>
        /// <returns>The keys.</returns>
        protected async override IAsyncEnumerable<int> GetAllKeysAsync(Func<IDbCommand> commandActivator, SampleContext context, [EnumeratorCancellation] CancellationToken cancellation = default)
        {
            await Task.Yield();
        ...
        /// <param name="entity">The entity.</param>
        /// <returns>Number of affected rows.</returns>
        protected override ValueTask<int> InsertAsync(Func<IDbCommand> commandActivator, SampleEntity entity, SampleContext context)
        {
        ...
        /// <returns>Number of affected rows.</returns>
        protected override async ValueTask<int> InsertRangeAsync(Func<IDbCommand> commandActivator, IEnumerable<SampleEntity> entities, SampleContext context, CancellationToken cancellationToken = default)
        {
        ...
        /// <param name="cancellationToken">The cancellation token.</param>
        /// <returns>Number of affected rows.</returns>
        protected override async ValueTask<int> InsertRangeAsync(Func<IDbCommand> commandActivator, IAsyncEnumerable<SampleEntity> entities, SampleContext context, CancellationToken cancellationToken = default)
        {
            using var command = SampleEntityRepository.CreateInsertCommand(commandActivator);
        ...
        /// <param name="entity">The entity.</param>
        /// <returns>Number of affected rows.</returns>
        protected override ValueTask<int> UpdateAsync(Func<IDbCommand> commandActivator, SampleEntity entity, SampleContext context)
        {
        ...
        /// <param name="cancellationToken">The cancellation token.</param>
        /// <returns>Number of affected rows.</returns>
        protected override async ValueTask<int> UpdateRangeAsync(Func<IDbCommand> commandActivator, IEnumerable<SampleEntity> entities, SampleContext context, CancellationToken cancellationToken)
        {
        ...
        /// <param name="cancellationToken">The cancellation token.</param>
        /// <returns>Number of affected rows.</returns>
        protected override async ValueTask<int> UpdateRangeAsync(Func<IDbCommand> commandActivator, IAsyncEnumerable<SampleEntity> entities, SampleContext context, CancellationToken cancellationToken)
        {
            using var command = SampleEntityRepository.CreateInsertCommand(commandActivator);
        ...
        /// <param name="entity">The entity.</param>
        /// <returns>Number of affected rows.</returns>
        protected override ValueTask<int> DeleteAsync(Func<IDbCommand> commandActivator, SampleEntity entity, SampleContext context)
        {
        ...
        /// <param name="cancellationToken">The cancellation token.</param>
        /// <returns>Number of affected rows.</returns>
        protected override ValueTask<int> DeleteRangeAsync(Func<IDbCommand> commandActivator, IEnumerable<SampleEntity> entities, SampleContext context, CancellationToken cancellationToken)
        {
        ...
        /// <param name="cancellationToken">The cancellation token.</param>
        /// <returns>Number of affected rows.</returns>
        protected override ValueTask<int> DeleteRangeAsync(Func<IDbCommand> commandActivator, IAsyncEnumerable<SampleEntity> entities, SampleContext context, CancellationToken cancellationToken)
        {
            return SampleEntityAsyncRepository.DeleteSampleEntitiesAsync(commandActivator, entities, cancellationToken);
        }
