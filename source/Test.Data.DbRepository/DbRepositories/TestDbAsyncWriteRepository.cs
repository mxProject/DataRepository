...
namespace Test.DbRepositories
{
    ...
    public class TestDbAsyncWriteRepository
    {
        ...
        public TestDbAsyncWriteRepository(ITestOutputHelper outputHelper)
        {
        ...
        public void Insert()
        {
            using var repo = new SampleEntityAsyncRepository(SampleDatabase.CreateConnection, true, SampleDatabase.ConfigureCommand);
        ...
        public async Task InsertAsync()
        {
            ...
            // insert entity
            Assert.Equal(1, await repo.InsertAsync(entity));
        ...
        public async Task InsertRangeAsync()
        {
            ...
            // insert entities
            Assert.Equal(list.Count, await repo.InsertRangeAsync(list));
        ...
        public async Task UpdateAsync()
        {
            ...
            // update entity
            Assert.Equal(1, await repo.UpdateAsync(entity));
        ...
        public async Task UpdateRangeAsync()
        {
            ...
            // update entity
            Assert.Equal(2, await repo.UpdateRangeAsync(list));
        ...
        public async Task DeleteAsync()
        {
            ...
            // delete entity
            Assert.Equal(1, await repo.DeleteAsync(entity));
        ...
        public async Task DeleteRangeAsync()
        {
            ...
            // delete entities
            Assert.Equal(2, await repo.DeleteRangeAsync(list));
