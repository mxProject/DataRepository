...
namespace Test.DbRepositories
{
    ...
    public class TestDbAsyncWriteRepositoryWithDbContext
    {
        /// <summary>
        ...
        public TestDbAsyncWriteRepositoryWithDbContext(ITestOutputHelper outputHelper)
        {
        ...
        {
            using var repo = new SampleEntityAsyncRepositoryWithDbContext(SampleDatabase.CreateConnection, true, SampleDatabase.ConfigureCommand);
        ...
        /// </summary>
        [Fact]
        public async Task InsertAsync_SpecifyingConnection()
        {
            using var repo = new SampleEntityAsyncRepositoryWithDbContext(SampleDatabase.CreateConnection, true, SampleDatabase.ConfigureCommand);
            ...
            {
                // insert entity
                Assert.Equal(1, await repo.InsertAsync(entity, context));
        ...
        /// </summary>
        [Fact]
        public async Task InsertAsync_SpecifyingTransaction()
        {
            using var repo = new SampleEntityAsyncRepositoryWithDbContext(SampleDatabase.CreateConnection, true, SampleDatabase.ConfigureCommand);
        ...
        /// </summary>
        [Fact]
        public async Task InsertRangeAsync_SpecifyingConnection()
        {
            using var repo = new SampleEntityAsyncRepositoryWithDbContext(SampleDatabase.CreateConnection, true, SampleDatabase.ConfigureCommand);
            ...
            {
                // insert entities
                Assert.Equal(list.Count, await repo.InsertRangeAsync(list, context));
        ...
        /// </summary>
        [Fact]
        public async Task InsertRangeAsync_SpecifyingTransaction()
        {
            using var repo = new SampleEntityAsyncRepositoryWithDbContext(SampleDatabase.CreateConnection, true, SampleDatabase.ConfigureCommand);
        ...
        /// </summary>
        [Fact]
        public async Task UpdateAsync_SpecifyingConnection()
        {
            using var repo = new SampleEntityAsyncRepositoryWithDbContext(SampleDatabase.CreateConnection, true, SampleDatabase.ConfigureCommand);
            ...
            // update entity
            Assert.Equal(1, await repo.UpdateAsync(entity, context));
        ...
        /// </summary>
        [Fact]
        public async Task UpdateAsync_SpecifyingTransaction()
        {
            using var repo = new SampleEntityAsyncRepositoryWithDbContext(SampleDatabase.CreateConnection, true, SampleDatabase.ConfigureCommand);
        ...
        /// </summary>
        [Fact]
        public async Task UpdateRangeAsync_SpecifyingConnection()
        {
            using var repo = new SampleEntityAsyncRepositoryWithDbContext(SampleDatabase.CreateConnection, true, SampleDatabase.ConfigureCommand);
            ...
            {
                // update entity
                Assert.Equal(2, await repo.UpdateRangeAsync(list, context));
        ...
        /// </summary>
        [Fact]
        public async Task UpdateRangeAsync_SpecifyingTransaction()
        {
            using var repo = new SampleEntityAsyncRepositoryWithDbContext(SampleDatabase.CreateConnection, true, SampleDatabase.ConfigureCommand);
        ...
        /// </summary>
        [Fact]
        public async Task DeleteAsync_SpecifyingConnection()
        {
            using var repo = new SampleEntityAsyncRepositoryWithDbContext(SampleDatabase.CreateConnection, true, SampleDatabase.ConfigureCommand);
            ...
            {
                // delete entity
                Assert.Equal(1, await repo.DeleteAsync(entity, context));
        ...
        /// </summary>
        [Fact]
        public async Task DeleteAsync_SpecifyingTransaction()
        {
            using var repo = new SampleEntityAsyncRepositoryWithDbContext(SampleDatabase.CreateConnection, true, SampleDatabase.ConfigureCommand);
        ...
        /// </summary>
        [Fact]
        public async Task DeleteRangeAsync_SpecifyingConnection()
        {
            using var repo = new SampleEntityAsyncRepositoryWithDbContext(SampleDatabase.CreateConnection, true, SampleDatabase.ConfigureCommand);
            ...
            {
                // delete entities
                Assert.Equal(2, await repo.DeleteRangeAsync(list, context));
        ...
        /// </summary>
        [Fact]
        public async Task DeleteRangeAsync_SpecifyingTransaction()
        {
            using var repo = new SampleEntityAsyncRepositoryWithDbContext(SampleDatabase.CreateConnection, true, SampleDatabase.ConfigureCommand);
