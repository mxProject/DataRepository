...
namespace Test.DbRepositories
{
    ...
    /// </summary>
    internal class SampleEntityAsyncReadRepositoryWithDbContext : DbAsyncReadRepositoryWithContextBase<SampleEntity, int, SampleDbContext>
    {
        /// <summary>
        ...
        public SampleEntityAsyncReadRepositoryWithDbContext(Func<IDbConnection> connectionActivator, bool useTransactionScope, Action<IDbCommand> configureCommand)
        ...
        /// <param name="context">The current context.</param>
        /// <returns>The entities.</returns>
        protected override async IAsyncEnumerable<SampleEntity> GetRangeAsync(Func<IDbCommand> commandActivator, IEnumerable<int> keys, SampleDbContext context, [EnumeratorCancellation] CancellationToken cancellationToken)
        {
            await Task.Yield();
        ...
        /// <param name="context">The current context.</param>
        /// <returns>The entities.</returns>
        protected override async IAsyncEnumerable<SampleEntity> GetRangeAsync(Func<IDbCommand> commandActivator, IAsyncEnumerable<int> keys, SampleDbContext context, [EnumeratorCancellation] CancellationToken cancellationToken)
        {
            await Task.Yield();
        ...
        /// <param name="context">The current context.</param>
        /// <returns>The entities.</returns>
        protected override async IAsyncEnumerable<SampleEntity> GetAllAsync(Func<IDbCommand> commandActivator, SampleDbContext context, [EnumeratorCancellation] CancellationToken cancellationToken)
        {
            await Task.Yield();
        ...
        /// <param name="context">The current context.</param>
        /// <returns>The keys.</returns>
        protected override async IAsyncEnumerable<int> GetAllKeysAsync(Func<IDbCommand> commandActivator, SampleDbContext context, [EnumeratorCancellation] CancellationToken cancellationToken)
        {
            await Task.Yield();
