...
namespace Test.DbRepositories
{
    ...
    public class TestDbAsyncWriteRepositoryWithContext
    {
        /// <summary>
        ...
        public TestDbAsyncWriteRepositoryWithContext(ITestOutputHelper outputHelper)
        {
        ...
        public void Insert()
        {
            using var repo = new SampleEntityAsyncRepositoryWithContext(SampleDatabase.CreateConnection, true, SampleDatabase.ConfigureCommand);
