...
namespace mxProject.Data.Repositories
{
    ...
    public abstract class DbAsyncReadWriteRepositoryWithContextBase<TEntity, TKey, TContext> : DbAsyncReadRepositoryWithContextBase<TEntity, TKey, TContext>, IAsyncWriteDataRepositoryWithContext<TEntity, TContext>
        where TContext : IDataRepositoryContext
    {
        ...
        protected DbAsyncReadWriteRepositoryWithContextBase(Func<IDbConnection> connectionActivator, bool useTransactionScope)
        ...
        protected DbAsyncReadWriteRepositoryWithContextBase(Func<IDbConnection> connectionActivator, bool useTransactionScope, Action<IDbCommand> configureCommand)
