...
namespace mxProject.Data.Repositories
{
    ...
    public abstract class DbAsyncReadWriteRepositoryBase<TEntity, TKey> : DbAsyncReadRepositoryBase<TEntity, TKey>, IAsyncWriteDataRepository<TEntity>
    {
        /// <summary>
        ...
        protected DbAsyncReadWriteRepositoryBase(Func<IDbConnection> connectionActivator, bool useTransactionScope)
        ...
        protected DbAsyncReadWriteRepositoryBase(Func<IDbConnection> connectionActivator, bool useTransactionScope, Action<IDbCommand> configureCommand)
