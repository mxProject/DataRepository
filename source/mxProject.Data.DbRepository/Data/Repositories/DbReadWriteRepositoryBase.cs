...
namespace mxProject.Data.Repositories
{
    ...
    public abstract class DbReadWriteRepositoryBase<TEntity, TKey> : DbReadRepositoryBase<TEntity, TKey>, IWriteDataRepository<TEntity>
    {
        ...
        protected DbReadWriteRepositoryBase(Func<IDbConnection> connectionActivator, bool useTransactionScope)
        ...
        protected DbReadWriteRepositoryBase(Func<IDbConnection> connectionActivator, bool useTransactionScope, Action<IDbCommand> configureCommand)
